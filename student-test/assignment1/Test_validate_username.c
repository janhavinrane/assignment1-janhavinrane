...
void test_validate_my_username()
{
    ...
    printf("my_username() returned %s\n", user_name);
    TEST_ASSERT_EQUAL_STRING_MESSAGE(user_name, conf_user_name, "Username from my_username() does not match username from conf/username.txt");
    //free(conf_user_name);
